...
class RegisterNewMember extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'street' => ['required', 'alpha', 'min:2'],
            'housenumber' => ['required', 'alpha_num'],
            'job' => ['alpha', 'min:2'],
            'employer' => ['alpha', 'min:2'],
            'university' => ['alpha', 'min:2'],
            'courseofstudies' => ['alpha', 'min:2'],
    ...
    public function messages()
    {
        return [
            ...
            'city.alpha' => 'City could only contain letters',
            ...
            'job.alpha' => 'Job could only contain letters',
            'job.min' => 'Job has to have at least two characters',
            'employer.alpha' => 'Employer could only contain letters',
            'employer.min' => 'Employer has to have at least two characters',
            'university.alpha' => 'University could only contain letters',
