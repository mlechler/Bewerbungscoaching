...
class UpdateMemberRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'emails' => ['required', 'emails', 'unique:employees', 'unique:members,emails,' . $id],
            'files' => ['array'],
            'zip' => ['required'],
            'city' => ['required'],
            'street' => ['required'],
    ...
    public function messages()
    {
        $messages = [
            ...
            'emails.unique' => 'Email has to be unique in Members and Employees',
            'emails.emails' => 'Email has to be a valid Email',
