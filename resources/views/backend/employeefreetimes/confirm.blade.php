...
@section('content')
    ...
    <div class="alert alert-danger">
        <strong>Warning!</strong> You are about to delete a Employee Free Time. All Files and Informations belonging to this Employee will be deleted. This action cannot be undone.
        <br>
